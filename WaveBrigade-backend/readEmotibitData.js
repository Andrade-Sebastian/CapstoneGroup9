...
var ancFilePath = '/Users/haley/Capstone_2024/CapstoneGroup9/WaveBrigade-backend/anc_from_streamer.csv';
writeHeaderstoCSV(ancFilePath, ancHeaders);
var auxHeaders = ['Package', 'PPG_Red', 'PPG_Infa_Red', 'PPG_Green', 'Timestamp', 'Unknown'];
var auxFilePath = '/Users/haley/Capstone_2024/CapstoneGroup9/WaveBrigade-backend/aux_from_streamer.csv';
...
function runExample() {
    return __awaiter(this, void 0, void 0, function () {
        var presets, data_current, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    while (true) {
                        ...
                        // if((passedTime - currentTime) > 5000){
                        //     break;
                        // }
                    }
                    return [3 /*break*/, 4];
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, sleep(3000)];
                case 3:
                    _a.sent();
                    board.stopStream();
