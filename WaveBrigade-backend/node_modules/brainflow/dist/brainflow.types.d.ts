export declare class BrainFlowError extends Error {
    __proto__: ErrorConstructor;
    exitCode: number;
    constructor(errorCode: number, msg: string);
}
export declare enum BoardIds {
    NO_BOARD = -100,
...
export declare enum IpProtocolTypes {
    NO_IP_PROTOCOL = 0,
    UDP = 1,
    TCP = 2
}
export declare enum BrainFlowPresets {
    DEFAULT_PRESET = 0,
    AUXILIARY_PRESET = 1,
    ANCILLARY_PRESET = 2
}
...
export declare enum AggOperations {
    MEAN = 0,
    MEDIAN = 1,
    EACH = 2
}
export declare enum WindowOperations {
    NO_WINDOW = 0,
    HANNING = 1,
    HAMMING = 2,
    BLACKMAN_HARRIS = 3
}
export declare enum DetrendOperations {
    NO_DETREND = 0,
    CONSTANT = 1,
    LINEAR = 2
}
export declare enum NoiseTypes {
    FIFTY = 0,
    SIXTY = 1,
    FIFTY_AND_SIXTY = 2
}
export declare enum WaveletDenoisingTypes {
    VISUSHRINK = 0,
    SURESHRINK = 1
}
...
export declare enum WaveletExtensionTypes {
    SYMMETRIC = 0,
    PERIODIC = 1
}
export declare enum NoiseEstimationLevelTypes {
    FIRST_LEVEL = 0,
    ALL_LEVELS = 1
}
export declare enum WaveletTypes {
    HAAR = 0,
    DB1 = 1,
    DB2 = 2,
    DB3 = 3,
...
export declare enum BrainFlowExitCodes {
    STATUS_OK = 0,
...
export declare enum BrainFlowMetrics {
    MINDFULNESS = 0,
    RESTFULNESS = 1,
    USER_DEFINED = 2
}
export declare enum BrainFlowClassifiers {
