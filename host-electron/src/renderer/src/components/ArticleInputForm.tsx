...
export default function ArticleInputForm(props: IArticleInputForm) {
  ...
  return (
    <>
      ...
      {/* <iframe src="https://arxiv.org/pdf/quant-ph/0410100.pdf" width="100%" height="600px"></iframe>
      <embed src="https://arxiv.org/pdf/quant-ph/0410100.pdf" width="100%" height="600px" type="application/pdf" /> */}
      {/* <EmbedPDF companyIdentifier='WaveBrigade'>
        <a href='https://cdn.simplepdf.com/simple-pdf/assets/sample.pdf'>Open sample.pdf</a>
      </EmbedPDF> */}
      {/* <EmbedPDF
      companyIdentifier='react-viewer'
  mode="inline"
  style={{ width: 400, height: 2200 }}
  documentURL="https://arxiv.org/pdf/quant-ph/0410100.pdf"
/> */}
        ...
        >
          ...
          <div className="w-full">
            ...
            <div className="flex justify-center mt-4">
              {usingLink ? (
                <div>
                  {/* <PDFViewer file={articleURL} onLoadError={(error) => console.error('PDF Load Error:', error)}/> */}
                  </div>
              ) : (
