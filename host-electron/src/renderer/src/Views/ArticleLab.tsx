...
import ArticleInput from '@renderer/components/ArticleInput'
...
export default function ArticleLab() {
  ...
  async function handleSubmit(e) {
    console.log("article source", photoLabImageSource);
    ...
    <div className="flex h-screen">
      ...
      <div className="flex flex-col max-sm:hidden items-center justify-center w-2/5">
        <SideComponent
          ...
          headingTitle="Create a Article Lab"
          description="Start creating your experiment with a article. Choose a title, write a description, and select a article to get started"
        />
      </div>
      ...
      <ArticleInput
        ...
        articleSource={JSON.stringify(photoLabImageSource)}
      />
